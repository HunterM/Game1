...
public abstract class Pehotinec extends Human {
    ...
    public Pehotinec(String name, float hp, int maxHp, int attack, int damageMin, int damageMax, int defense, int speed,
                   int posX, int posY) {
    ...
    public boolean step(ArrayList<Human> team1, ArrayList<Human> team2) {
        ...
        if (victim.coords.getDistance(coords) < 2) {
            ...
            Point2D tempvc = coords.chooseWay(victim.coords);
